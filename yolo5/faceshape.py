...
# FILE = Path(__file__).resolve() #/content/yolov5/detect.py
# ROOT = FILE.parents[0]  # YOLOv5 root directory / /content/yolov5/
...
def faceshape_best(User_img):
  result = []
  weights= ['yolo5/faceshape_best.pt']  # model path or triton URL
